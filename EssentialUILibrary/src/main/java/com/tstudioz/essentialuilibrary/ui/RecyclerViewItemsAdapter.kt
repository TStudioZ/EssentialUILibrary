...
class RecyclerViewItemsAdapter<T, V> (private val listener: OnItemRecyclerViewListener<T, V>,
    ...
    interface OnItemRecyclerViewListener<T, V> {
        fun onItemSelected(item: T, holder: V)
    }
    ...
    override fun onBindViewHolder(holder: V, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            listener.onItemSelected(item, holder)
        }
    }
}